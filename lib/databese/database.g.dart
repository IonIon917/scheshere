...
class $SchedulesTable extends Schedules
    with TableInfo<$SchedulesTable, ScheduleTable> {
  @override
  ...
  @override
  VerificationContext validateIntegrity(Insertable<ScheduleTable> instance,
  ...
  @override
  ScheduleTable map(Map<String, dynamic> data, {String? tablePrefix}) {
...
class ScheduleTable extends DataClass implements Insertable<ScheduleTable> {
  final int id;
  ...
  @override
  String toString() {
    return (StringBuffer('ScheduleTable(')
          ..write('id: $id, ')
...
class SchedulesCompanion extends UpdateCompanion<ScheduleTable> {
  final Value<int> id;
  ...
  SchedulesCompanion.insert({
    ...
    required int date,
        ...
        type = Value(type),
        date = Value(date);
  static Insertable<ScheduleTable> custom({
    Expression<int>? id,
