...
const ScheduleSchema = CollectionSchema(
  ...
  links: {
    r'category': LinkSchema(
      id: -7413474549699343703,
      name: r'category',
      target: r'Category',
      single: true,
    ),
    r'calendar': LinkSchema(
      id: 2505739508188341560,
      name: r'calendar',
      target: r'Calendar',
      single: true,
    )
...
extension ScheduleQueryWhereSort on QueryBuilder<Schedule, Schedule, QWhere> {
  ...
  QueryBuilder<Schedule, Schedule, QAfterWhere> anyUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension ScheduleQueryWhere on QueryBuilder<Schedule, Schedule, QWhereClause> {
  ...
  QueryBuilder<Schedule, Schedule, QAfterWhereClause> updatedAtEqualTo(
      DateTime updatedAt) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Schedule, Schedule, QAfterWhereClause> updatedAtNotEqualTo(
      DateTime updatedAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Schedule, Schedule, QAfterWhereClause> updatedAtGreaterThan(
    DateTime updatedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Schedule, Schedule, QAfterWhereClause> updatedAtLessThan(
    DateTime updatedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Schedule, Schedule, QAfterWhereClause> updatedAtBetween(
...
extension ScheduleQueryFilter
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> placeEqualTo(
    String value, {
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> placeGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> placeLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> placeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> placeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> placeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> placeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> placeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> placeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'place',
        value: '',
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> placeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'place',
        value: '',
...
extension ScheduleQueryLinks
    on QueryBuilder<Schedule, Schedule, QFilterCondition> {
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> category(
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> categoryIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'category', 0, true, 0, true);
    });
  }

  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> calendar(
  ...
  QueryBuilder<Schedule, Schedule, QAfterFilterCondition> calendarIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension ScheduleQuerySortBy on QueryBuilder<Schedule, Schedule, QSortBy> {
  ...
  QueryBuilder<Schedule, Schedule, QAfterSortBy> sortByPlace() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'place', Sort.asc);
    });
  }

  QueryBuilder<Schedule, Schedule, QAfterSortBy> sortByPlaceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ScheduleQuerySortThenBy
  ...
  QueryBuilder<Schedule, Schedule, QAfterSortBy> thenByPlace() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'place', Sort.asc);
    });
  }

  QueryBuilder<Schedule, Schedule, QAfterSortBy> thenByPlaceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'place', Sort.desc);
    });
  }
...
extension ScheduleQueryWhereDistinct
  ...
  QueryBuilder<Schedule, Schedule, QDistinct> distinctByPlace(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ScheduleQueryProperty
  ...
  QueryBuilder<Schedule, String, QQueryOperations> placeProperty() {
    return QueryBuilder.apply(this, (query) {
